...
export const factories = {
    ...
    presetFactoryValues: [
        ...
        [200, 30, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//3
        [300, 40, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//4
        [400, 50, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//5
        [500, 60, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//6
        [600, 70, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//7
        [700, 80, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//8
        [800, 90, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//9
        [20, 100, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//10
        [1000, 110, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//11
        [1100, 120, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//12
        [1200, 130, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//13
        [1300, 140, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//14
        [1400, 150, .9, 1, 2, 1, 3, 9, 13, 0, 5, 1, 2],//15
    ],
